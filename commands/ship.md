...
- Write the PR body to `.tmp/pr-body-$RANDOM.md` (use a unique filename), then create the PR using the pull request CLI or API for the source code hosting declared in the project's CLAUDE.md:
