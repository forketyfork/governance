...
| Land       | Stack          | GitHub                                                              | PRD | ARCH | TRACE | CONV | Lint | CI  | Coverage | Pre-commit | Branch Prot. | Dep. Updates | Observability | Status  |
| ---------- | -------------- | ------------------------------------------------------------------- | --- | ---- | ----- | ---- | ---- | --- | -------- | ---------- | ------------ | ------------ | ------------- | ------- |
...
- **Lint / CI / Coverage / Pre-commit / Branch Prot. / Dep. Updates:** Automated guardrails
